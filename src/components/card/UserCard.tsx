      ...
      >
        ...
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-4 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D] bg-background">
          ...
          >
            {showSectionOne && (
              <motion.div
                className="relative flex flex-1 flex-col md:flex-row md:justify-between font-mono gap-2 md:gap-0"
                initial={{
                  opacity: 0,
                  y: -20,
                }}
              ...
              >
                ...
                >
                  <Avatar className="h-24 w-24 mb-4">
                    <AvatarImage src={data.logo.url} alt="Profile" />
                  </Avatar>
                  ...
                  <section className="hidden md:block">
                    ...
                    <div className="flex flex-col flex-wrap gap-1">
                      ...
                      <span className="text-zinc-400">2020-2021</span>
                    </div>
                  </section>
                ...
                <div className="md:w-2/3">
                  <section className="mb-4 hidden md:flex flex-col gap-2 md:justify-between justify-center items-center md:items-start">
                    <h2 className="text-lg font-semibold md:mb-2">About Me</h2>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex flex-col flex-1 w-full gap-2">
                              ...
                              <li>
                                <span
                                  className={clsx("font-medium mb-2", {
                                    "cursor-pointer underline underline-offset-3":
                                      project.url,
                                  })}
                                >
                                  {project.title}
                      ...
                      <section className="mt-4 flex md:justify-end flex-col md:items-baseline items-center justify-center">
                        <button
                          className="shadow-[inset_0_0_0_2px_#616467] text-black px-8 py-2 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200 flex gap-2 items-center cursor-pointer"
                          onClick={() => {
                        ...
                        <button
                          className="mt-4 px-6 py-2 bg-transparent text-white rounded-lg font-bold transform hover:-translate-y-1 transition duration-400 md:hidden"
                          onClick={() => {
              ...
              >
                <section className="">
                  ...
                  <div className="text-sm flex flex-col flex-wrap gap-1">
                    ...
                    <span className="text-zinc-300">2020-2021</span>
                  </div>
                </section>
                <section>
                  <h2 className="text-base font-semibold mb-2">
                  ...
                  <ul className="space-y-1 text-sm flex flex-col gap-2">
                    {data.work_experience?.slice(0, 1).map((work, index) => (
                      <li key={index}>
                        <span className="font-medium">{work.title}</span>
                        <span className="text-zinc-300">
                          - {work.from} to {work.to}
                ...
                <button
                  className="px-6 py-2 bg-transparent text-white rounded-lg font-bold transform hover:-translate-y-1 transition duration-400 md:hidden"
                  onClick={() => {
